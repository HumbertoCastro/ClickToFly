...
describe("createAmazonFallbackBook", () => {
  it("creates a database-safe neutral record without durable Amazon content", () => {
    expect(createAmazonFallbackBook(" b0abc12345 ")).toEqual({
      source: "amazon",
      sourceId: "B0ABC12345",
      title: "Livro Amazon B0ABC12345",
      subtitle: "",
...
describe("Amazon catalog configuration and safety", () => {
  ...
  it("rejects an enabled Amazon mode without a public Edge Function URL", () => {
    expect(() =>
      getAmazonCatalogConfig({
